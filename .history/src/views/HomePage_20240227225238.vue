        ...
        <div class="px-8 mt-8">
          <div v-if="list.length > 0">
            <div v-if="header != ''">
              ...
              <div class="w-full">
                <LineChart class="w-full h-48" :chart-data="chartData" :options="chartOptions" :data="processedChartData"></LineChart>
              </div>
...
import { Chart as ChartJS, registerables, ChartOptions, ChartData, Point } from 'chart.js';
