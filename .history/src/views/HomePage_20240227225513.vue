        ...
        <div class="px-8 mt-8">
          <div v-if="list.length > 0">
            <div v-if="header != ''">
              ...
              <div class="w-full">
                <LineChart class="w-full h-64" :chart-data="chartData" :options="chartOptions" :data="processedChartData"></LineChart>
              </div>
...
import { Chart as ChartJS, Title, ChartOptions, ChartData, Tooltip, Legend, BarElement, CategoryScale, LinearScale, Point } from 'chart.js'
...
export default defineComponent({
  ...
  computed: {
    processedChartData(): any {
      return this.chartData.datasets[0].data as (number | Point | null)[];
    },
  },
  components: {
    IonPage,
