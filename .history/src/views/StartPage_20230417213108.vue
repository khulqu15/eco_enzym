<template>
  <div id="splash-content" class="min-h-screen bg-base-200 grid grid-cols-1 items-center justify-center">
    ...
    <div class="fixed left-0 bottom-0 w-full p-8 bg-base-100 rounded-t-2xl">
        <button class="btn bg-primary w-full"></button>
    </div>
  </div>
</template>
